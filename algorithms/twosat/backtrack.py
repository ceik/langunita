...
# Recursive backtracking algorithm for 2Sat
# Doesn't scale enough to solve assignment, need non-recursive version
...
class Backtrack:
    ...
    def main(self):
        ...
        #         continue
        #     true_works = self.check_setting(var_id, True)
        #     if true_works:
        #         self.vars[var_id] = True
        #     else:
        #         false_works = self.check_setting(var_id, False)
        #         if false_works:
        #             self.vars[var_id] = False
                # else:
                #     print('not sat')
                #     return 'not sat'
